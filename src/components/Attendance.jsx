...
const Attendance = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://hr-management-be.onrender.com/api/attendance/allAttendance");
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://hr-management-be.onrender.com/api/attendance/${id}`);
